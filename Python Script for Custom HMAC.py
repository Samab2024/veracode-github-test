...
Policy_Name=response['_embedded']['applications'][0]['profile']['policies']['name'][0]
Policy_Check_Status=response['_embedded']['applications'][0]['profile']['policies']['policy_compliance_status'][0]
